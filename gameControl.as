package  {
	...
	public class gameControl {
		...
		{
			main.gameUI.leftBtn.addEventListener(MouseEvent.MOUSE_OVER, motionLeft_BeginHandler);
			main.gameUI.leftBtn.addEventListener(MouseEvent.MOUSE_OUT, motionLeft_EndHandler);
			main.gameUI.rightBtn.addEventListener(MouseEvent.MOUSE_OVER, motionRight_BeginHandler);
			main.gameUI.rightBtn.addEventListener(MouseEvent.MOUSE_OUT, motionRight_EndHandler);
		}
		private function removeChickenListener():void
		{
			main.gameUI.leftBtn.removeEventListener(MouseEvent.MOUSE_OVER, motionLeft_BeginHandler);
			main.gameUI.leftBtn.removeEventListener(MouseEvent.MOUSE_OUT, motionLeft_EndHandler);
			main.gameUI.rightBtn.removeEventListener(MouseEvent.MOUSE_OVER, motionRight_BeginHandler);
			main.gameUI.rightBtn.removeEventListener(MouseEvent.MOUSE_OUT, motionRight_EndHandler);
		}
		public function motionLeft_BeginHandler(event:MouseEvent):void
		{
			c_chickSpeed =  -  chickSpeed;
		}
		public function motionLeft_EndHandler(event:MouseEvent):void
		{
			if (c_chickSpeed<0)
			{
				c_chickSpeed = 0;
		...
		public function motionRight_BeginHandler(event:MouseEvent):void
		{
			c_chickSpeed = chickSpeed;
		}
		public function motionRight_EndHandler(event:MouseEvent):void
		{
			if (c_chickSpeed>0)
			{
				c_chickSpeed = 0;
